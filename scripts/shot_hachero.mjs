...
await page.evaluate(() => { window.__colosos.tickN(4, { attack: true }); window.__colosos.setPaused(true); });
await frames(2);
...
console.log('shots: 22_seleccion_cinco, 23_seleccion_hachero, 24_hachero_mundo, 25_inventario_arrastre');
await browser.close();
server.kill();
process.exit(0);
