...
export const CLASSES: ClassDef[] = [
  ...
  },
  {
    ...
    nombre: 'Hachero',
    rol: 'Bárbaro',
    armaNombres: ['Hacha de leñador', 'Hacha de guerra', 'Hacha Parterrocas'],
    desc: 'Tala los bosques que crecen en el lomo. Hacha a dos manos: lenta, brutal y sin escudo que valga.',
