  ...
  ballestero: [
    {
      id: 'pulso_firme',
      nombre: 'Pulso Firme',
      desc: '+6% de probabilidad de crítico por rango.',
      tier: 1,
      maxRank: 3,
      per: { critChance: 0.06 },
    },
    {
      id: 'cuerda_de_acero',
      nombre: 'Cuerda de Acero',
      desc: '+8% de daño con la ballesta por rango.',
      tier: 1,
      maxRank: 3,
      per: { basicDmg: 0.08 },
    },
    {
      id: 'punta_dentada',
      nombre: 'Punta Dentada',
      desc: 'El virote no sale limpio: 6 de daño por segundo durante 3 s, por rango.',
      tier: 2,
      maxRank: 2,
      per: { dotDps: 6 },
    },
    ...
    {
      id: 'muesca',
      nombre: 'Muesca de Caza',
      desc: 'Tus críticos pegan un 22% más fuerte por rango.',
      tier: 2,
      maxRank: 2,
      per: { critMult: 0.22 },
    },
    {
      ...
      desc: 'Abre tu segunda habilidad (tecla 2): vaciar el cargador en abanico.',
      tier: 3,
      maxRank: 1,
      per: { unlockAbility2: true },
    },
